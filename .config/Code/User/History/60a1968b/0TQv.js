    ...
    individualBtn.addEventListener('click', ()=>{
        ...
        console.log(clicked);
         ...
         if (clicked === 'Rock' && computerChoice === 'Paper'){
            ...
            document.getElementById('msg').innerHTML= msgComp;
            ++computerScore;
            document.getElementById('displayedComputerScore').innerHTML = computerScore;            document.getElementById('displayedPlayerScore').innerHTML = computerScore;
            document.getElementById('displayedPlayerScore').innerHTML = playerScore;
            ...
            ++playerScore;
            document.getElementById('displayedPlayerScore').innerHTML = playerrScore;            document.getElementById('displayedPlayerScore').innerHTML = computerScore;
            document.getElementById('displayedComputerScore').innerHTML = computerScore;
            ...
            ++playerScore;
            document.getElementById('displayedPlayerScore').innerHTML = playerScore;            document.getElementById('displayedPlayerScore').innerHTML = computerScore;
            document.getElementById('displayedComputerScore').innerHTML = computerScore;
            document.getElementById('msg').innerHTML= msgPlay;
